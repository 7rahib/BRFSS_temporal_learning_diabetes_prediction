...
TWO FUNCTIONS:
    train_normal() — Task 1 and standalone baselines. Uses a learning rate
                     scheduler because there are no EWC constraints.

    train_ewc()    — Tasks 2 and 3. Uses a FIXED learning rate with NO
                     scheduler. This is the critical fix.
